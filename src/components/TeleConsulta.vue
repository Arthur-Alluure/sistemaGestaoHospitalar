          ...
          <div class="teleconsulta-item" v-for="consulta in consultasDisponiveis" :key="consulta.id">
            <div class="consulta-info">
              ...
              <p class="consulta-status">
                <span :class="['status-badge', consulta.disponivel ? 'status-disponivel' : 'status-agendado']">
      ...
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="salvarConsulta" class="modal-body">
          ...
          <div v-if="novaConsulta.tipo === 'agendada'" class="form-row">
            <div class="form-group">
              ...
              <input 
                ...
                :required="novaConsulta.tipo === 'agendada'"
                :min="dataMinima"
                class="form-control"
              />
            </div>
          ...
          <div class="form-group">
            ...
            <textarea 
              id="observacoes" 
              v-model="novaConsulta.observacoes" 
              rows="3"
              class="form-control"
...
.historico-data, .historico-duracao {
  margin: 0 0 2px 0;
  color: #666;
  font-size: 14px;
}
...
.screen-btn:hover, .chat-btn:hover {
  background: #91415c;
}
