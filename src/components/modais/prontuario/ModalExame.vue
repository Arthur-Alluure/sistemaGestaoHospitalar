    ...
    <div v-if="isOpen" class="modal-overlay" @click="fechar">
        <div class="modal-content" @click.stop>
            <div class="modal-header">
                <h2><i class="bi bi-clipboard-pulse"></i> Adicionar Exame</h2>
            ...
            <form @submit.prevent="salvar" class="modal-body">
                ...
                <div class="form-group">
                    <label>Subtipo/Detalhes</label>
                    <input type="text" v-model="form.subtipo" class="form-control"
                        placeholder="Ex: Completo, Tórax PA" />
                </div>
                <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn-primary">
                        <i class="bi bi-check-circle"></i> Adicionar Exame
                    </button>
                </div>
            </form>
        </div>
